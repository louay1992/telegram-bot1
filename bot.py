...
async def build_application(webhook_url: Optional[str] = None) -> Application:
    """
    ...
    if webhook_url:
        ...
        # في الإصدار الجديد من مكتبة python-telegram-bot، لا نستخدم webhook مع ApplicationBuilder
        # سنقوم بتعيين الويب هوك بعد إنشاء التطبيق
    ...
    # تعيين الويب هوك بعد إنشاء التطبيق
    if webhook_url:
        bot = _application.bot
        # إزالة أي webhook سابق وتعيين webhook جديد
        try:
